'use strict';
(() => {
  if (window.__siren_lock_v2266bNF) return; window.__siren_lock_v2266bNF = true;
  ...
  const keep = /script\.v2266b-dualnext-stream-nofilter\.js/i;
  ...
  const LRU_KEY='siren_seen_titles_v2266bNF';
